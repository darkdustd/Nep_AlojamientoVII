...
class PagosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post pagos_url, params: { pago: { cvv_tarjeta: @pago.cvv_tarjeta, fecha_tarjeta: @pago.fecha_tarjeta, nombre_tarjeta: @pago.nombre_tarjeta, numero_tarjeta: @pago.numero_tarjeta } }
    end
  ...
  test "should update pago" do
    patch pago_url(@pago), params: { pago: { cvv_tarjeta: @pago.cvv_tarjeta, fecha_tarjeta: @pago.fecha_tarjeta, nombre_tarjeta: @pago.nombre_tarjeta, numero_tarjeta: @pago.numero_tarjeta } }
