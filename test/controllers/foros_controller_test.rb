...
class ForosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create foro" do
    assert_difference('Foro.count') do
      post foros_url, params: { foro: { comentario: @foro.comentario, puntuacion: @foro.puntuacion } }
    end
  ...
  test "should update foro" do
    patch foro_url(@foro), params: { foro: { comentario: @foro.comentario, puntuacion: @foro.puntuacion } }
